---
title: "List of Populous levels"
categories: data
---

The following is a list of all level codes for the Commodore Amiga version of
_Populous_. See also Notes at the bottom, and also the page on
[Level format](../analysis/level-format.html) for an explanation of the fields
and how levels are generated.

### List of levels

| # | Seed | Code | Rating | Reactions | His Powers | Your Powers | Water | Swamps | Build | Terrain | Your Pop | His Pop | RNG
|---|------|------|--------|-----------|------------|-------------|-------|--------|-------|---------|----------|---------|----
| 0 | 24df | SHISODING | Very Poor (10) | Very Slow (10) |  | ESKVFA | Fatal | Bottomless | Near people | Grass | 3 | 3 | 6302 
| 1 | 5c04 | HURTOUTORD | Very Poor (10) | Very Slow (10) |  | ESKVFA | Fatal | Bottomless | Near people | Grass | 3 | 3 | 6302 
...
| 435 | 58be | BUGLOPDON | Very Good (1) | Very Fast (1) | ESKVFA | ESKVFA | Harmful | Shallow | Near towns | Grass | 1 | 3 | 0280 
...
| 998 | 1f1d | SWAOXDOR |  |  |  |  |  |  |  |  |  |  |  
| 999 | 5642 | KILLUSPAL |  |  |  |  |  |  |  |  |  |  |  
| 1000 | 0d67 | EOADIEPERT |  |  |  |  |  |  |  |  |  |  |  

### Notes

- The level number, seed, and code are calculated based on the algorithm as it
  appears in the disassembled game code.
- All other level trait data has been extracted directly from the file
  `level.dat`. This file only covers levels 0 to 494, and the set of traits
  changes every 5 levels. Codes 495 to 1,000 will work, but operate unusually,
  drawing their traits from the last map code entered.
- Level 0 is also called GENESIS.
